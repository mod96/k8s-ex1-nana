...
app.get("/", function (req, res) {
  console.log("main page requested, mongo url is: " + process.env.DB_URL);
...
app.get("/get-profile", function (req, res) {
  let response = {};
  console.log("get-profile requested, process env is: " + process.env);
  console.log("and dbURL is : " + mongoUrlK8s);
  // Connect to the db
  MongoClient.connect(mongoUrlK8s, mongoClientOptions, function (err, client) {
    if (err) throw err;
